...
# if QT_VERSION > QT_VERSION_CHECK(5, 6, 0)
    ...
    class GOOGLEQT_DLLSPEC VoidType
    {
    public:
    ...
    class GOOGLEQT_DLLSPEC NotAnException
    {
    public:
    ...
    class GOOGLEQT_DLLSPEC ListFromJsonLoader
    {
    public:
    ...
    class UrlBuilder;
    class GOOGLEQT_DLLSPEC QParamArg
    {
    public:
    ...
    class GOOGLEQT_DLLSPEC PathArg : public P
    {
    public:
    ...
    template <class P, class D>
    class GOOGLEQT_DLLSPEC PathWithIdArg : public P
    {
    public:
        PathWithIdArg() {}
    ...
    class GOOGLEQT_DLLSPEC UrlBuilder
    {
    public:
    ...
    template <class T>
    class GOOGLEQT_DLLSPEC JsonFactory
    {
    public:
    ...
    template<class T>
    class GOOGLEQT_DLLSPEC QParamArgWithBody : public QParamArg
    {
    public:
