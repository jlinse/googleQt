...
namespace googleQt{
    ...
    */
    ...
    class GOOGLEQT_DLLSPEC ConcurrentBaseRunner : public EndpointRunnable
    {
    public:
    ...
    */
    ...
    class GOOGLEQT_DLLSPEC ConcurrentValueRunner : public ConcurrentBaseRunner<ARG_PARAM, ROUTER>
    {
    public:
    ...
    */
    template <class ARG_PARAM, class ROUTER>
    class GOOGLEQT_DLLSPEC ConcurrentArgRunner : public ConcurrentBaseRunner<ARG_PARAM, ROUTER>
    {
    public:
