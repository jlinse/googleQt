...
namespace googleQt {
    ...
    class GOOGLEQT_DLLSPEC CacheData
    {
    public:
    ...
    class GOOGLEQT_DLLSPEC CacheDataWithHistory: public CacheData
    {
    public:
    ...
    template<class O>
    class GOOGLEQT_DLLSPEC GoogleCacheBase
    {
    public:
    ...
    template <class O>
    class GOOGLEQT_DLLSPEC CacheDataResult
    {
    public:
    ...
    class GOOGLEQT_DLLSPEC LocalPersistentStorage
    {
    public:
    ...
    template <class O, class R>
    class GOOGLEQT_DLLSPEC GoogleCache : public GoogleCacheBase<O>
    {
    public:
    ...
    */
    template <class O>
    class GOOGLEQT_DLLSPEC CacheQueryTask : public CacheTaskParent<O>
    {
    public:
