...
namespace googleQt
{
    ...
    namespace gtask_cache {
        ...
        class GOOGLEQT_DLLSPEC TaskInfo
        {
        public:
        ...
        class GOOGLEQT_DLLSPEC TaskList
        {
        public:
        ...
        class GOOGLEQT_DLLSPEC TaskCache
        {
        public:
        ...
        */
        class GOOGLEQT_DLLSPEC TaskListReceiver
        {
        public:
        ...
        class GOOGLEQT_DLLSPEC TaskReceiver
        {
        public:
        ...
        class GOOGLEQT_DLLSPEC GtaskCacheRoutes : public QObject
        {
            Q_OBJECT
        public:
