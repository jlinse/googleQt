...
namespace googleQt {
    namespace gcontact {
         ...
         */
        class GOOGLEQT_DLLSPEC NameInfo: public NullablePart
        {    
        public:
        ...
        */
        class GOOGLEQT_DLLSPEC OrganizationInfo : public NullablePart
        {
        public:
            OrganizationInfo();
        ...
        */
        class GOOGLEQT_DLLSPEC PostalAddress : public NullablePart
        {
        public:
        ...
        */
        class GOOGLEQT_DLLSPEC PhoneInfo : public NullablePart
        {
        public:
        ...
        */
        class GOOGLEQT_DLLSPEC EmailInfo : public NullablePart
        {
        public:
            EmailInfo();
        ...
        photo info
        */
        class GOOGLEQT_DLLSPEC PhotoInfo : public NullablePart
        {
        public:
            enum EStatus
                {
         ...
         */
        class GOOGLEQT_DLLSPEC GroupMembershipInfo : public NullablePart
        {
        public:
            GroupMembershipInfo();
        ...
        */
        class GOOGLEQT_DLLSPEC UserDefinedFieldInfo : public NullablePart
        {
        public:
        ...
        list of emails
        */
        class GOOGLEQT_DLLSPEC EmailInfoList : public LabeledPartList<EmailInfo>
        {
        public:
        ...
        /**
            list of phones
        */
        class GOOGLEQT_DLLSPEC PhoneInfoList : public LabeledPartList<PhoneInfo>
        {
        public:
        ...
        */
        class GOOGLEQT_DLLSPEC PostalAddressList : public LabeledPartList<PostalAddress>
        {
        public:
        ...
        list of group links
        */
        class GOOGLEQT_DLLSPEC GroupMembershipInfoList : public PartList<GroupMembershipInfo>
        {
        public:
        ...
        */
        class GOOGLEQT_DLLSPEC UserDefinedFieldInfoList : public PartList<UserDefinedFieldInfo>
        {
        public:
