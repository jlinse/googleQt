...
namespace googleQt {
    namespace gcontact {
        ...
        */
        class GOOGLEQT_DLLSPEC NullablePart
        {
        public:
            NullablePart() {}
        ...
        */
        class GOOGLEQT_DLLSPEC DbPersistant : public NullablePart
        {                        
        public:
            DbPersistant();
        ...
        class GOOGLEQT_DLLSPEC ContactXmlPersistant : public DbPersistant
        {
        public:
        ...
        */
        ...
        protected:
          ...
          */
        template <class T>
        class GOOGLEQT_DLLSPEC LabeledPartList : public PartList<T>
        {
        public:
        ...
        template <class T>
        class GOOGLEQT_DLLSPEC InfoList
        {
        public:
        ...
        class GOOGLEQT_DLLSPEC BatchBuilderInfoList: public InfoList<T>
        {
        public:
        ...
        class GOOGLEQT_DLLSPEC BatchRequest
        {
        public:
        ...
        class GOOGLEQT_DLLSPEC BatchResult
        {
        public:
